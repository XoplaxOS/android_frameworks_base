...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private GlobalActionsDialog createDialog() {
        ...
        // next: screenrecord
        // only shown if enabled, disabled by default
        boolean showScreenrecord = Settings.XOPLAX.getIntForUser(cr,
                Settings.XOPLAX.POWER_MENU_SCREENRECORD_ENABLED, 0, UserHandle.USER_CURRENT) == 1;
        if (showScreenrecord) {
            mItems.add(
        ...
        // next: Nav Bar toggle
        boolean showNavBar = Settings.XOPLAX.getBoolean(cr,
                Settings.XOPLAX.POWER_MENU_NAV_BAR_ENABLED, false);
    ...
    private void onNavBarModeChanged() {
        ...
        boolean navBarModeOn = Settings.XOPLAX.getIntForUser(
                mContext.getContentResolver(),
                Settings.XOPLAX.NAVIGATION_BAR_SHOW,

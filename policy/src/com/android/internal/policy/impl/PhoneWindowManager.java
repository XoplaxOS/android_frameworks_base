...
import android.app.XoplaXBusyDialog;
...
import com.android.internal.util.xoplax.AwesomeAction;
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        protected void observe() {
            ...
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.NAVIGATION_BAR_HEIGHT), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.NAVIGATION_BAR_WIDTH), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
    ...
    private void setHasNavigationBar() {
        ...
        final int hasNavigationBar = Settings.XOPLAX.getIntForUser(
                mContext.getContentResolver(),
                Settings.XOPLAX.NAVIGATION_BAR_SHOW, -1,
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mNavigationBarHeight =
                    Settings.XOPLAX.getIntForUser(resolver,
                            Settings.XOPLAX.NAVIGATION_BAR_HEIGHT, -2,
                            UserHandle.USER_CURRENT);
            ...
            mNavigationBarHeightLandscape =
                    Settings.XOPLAX.getIntForUser(resolver,
                            Settings.XOPLAX.NAVIGATION_BAR_HEIGHT_LANDSCAPE, -2,
                            UserHandle.USER_CURRENT);
            ...
            mNavigationBarWidth =
                    Settings.XOPLAX.getIntForUser(resolver,
                            Settings.XOPLAX.NAVIGATION_BAR_WIDTH, -2,
                            UserHandle.USER_CURRENT);
    ...
    private void performScreenRecord() {
        final Intent recordIntent = new Intent("com.xoplax.action.NOTIFY_RECORD_SERVICE");
    ...
    XoplaXBusyDialog mBootMsgDialog = null;
        ...
        mHandler.post(new Runnable() {
            @Override public void run() {
                if (mBootMsgDialog == null) {
                    mBootMsgDialog = new XoplaXBusyDialog(mContext, android.R.style.Theme_Translucent_NoTitleBar);

    ...
    class Configuration extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_SHOW_ALWAYS), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_POCKET_MODE), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HIDE_LOW_PRIORITY), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HIDE_NON_CLEARABLE), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_DISMISS_ALL), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_EXPANDED_VIEW), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_FORCE_EXPANDED_VIEW), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_WAKE_ON_NOTIFICATION), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HEIGHT), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_OFFSET_TOP), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_PRIVACY_MODE), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_DYNAMIC_WIDTH), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_EXCLUDED_APPS), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_COLOR), false, this);
        }
        ...
        private void updateSettings() {
            showAlways = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_SHOW_ALWAYS, showAlways ? 1 : 0) == 1;
            pocketMode = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_POCKET_MODE, pocketMode ? 1 : 0) == 1;
            hideLowPriority = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HIDE_LOW_PRIORITY, hideLowPriority ? 1 : 0) == 1;
            hideNonClearable = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HIDE_NON_CLEARABLE, hideNonClearable ? 1 : 0) == 1;
            dismissAll = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_DISMISS_ALL, dismissAll ? 1 : 0) == 1;
            privacyMode = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_PRIVACY_MODE, privacyMode ? 1 : 0) == 1;
            expandedView = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_EXPANDED_VIEW, expandedView ? 1 : 0) == 1
                    && !privacyMode;
            forceExpandedView = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_FORCE_EXPANDED_VIEW, forceExpandedView ? 1 : 0) == 1
                    && !privacyMode;
            wakeOnNotification = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_WAKE_ON_NOTIFICATION, wakeOnNotification ? 1 : 0) == 1;
            notificationsHeight = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HEIGHT, notificationsHeight);
            offsetTop = Settings.XOPLAX.getFloat(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_OFFSET_TOP, offsetTop);
            dynamicWidth = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_DYNAMIC_WIDTH, dynamicWidth ? 1 : 0) == 1;
            String excludedApps = Settings.XOPLAX.getString(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_EXCLUDED_APPS);
            notificationColor = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_COLOR, notificationColor);

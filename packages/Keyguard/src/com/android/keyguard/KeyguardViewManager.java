...
public class KeyguardViewManager {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_SEE_THROUGH), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_BLUR_RADIUS), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS), false, this);
        }
    ...
    private void updateSettings() {
      mLockscreenNotifications = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS, mLockscreenNotifications ? 1 : 0) == 1;
        ...
        mSeeThrough = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                Settings.XOPLAX.LOCKSCREEN_SEE_THROUGH, 0) == 1;
        mBlurRadius = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                Settings.XOPLAX.LOCKSCREEN_BLUR_RADIUS, mBlurRadius);

...
public class KeyguardSelectorView extends LinearLayout implements KeyguardSecurityView {
    ...
    protected void onFinishInflate() {
        ...
        mDoubleTapGesture = new GestureDetector(mContext,
            ...
            public boolean onDoubleTap(MotionEvent e) {
                int doubletapoption = Settings.XOPLAX.getInt(mContext.getContentResolver(), Settings.XOPLAX.LOCKSCREEN_GLOWPAD_DOUBLETAP_OPTION, 0);
        ...
        if (Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.DOUBLE_TAP_GLOWPAD_GESTURE, 0) == 1) {
    ...
    public void updateLockscreenBattery(KeyguardUpdateMonitor.BatteryStatus status) {
        if (Settings.XOPLAX.getIntForUser(
                mContext.getContentResolver(),
                Settings.XOPLAX.BATTERY_AROUND_LOCKSCREEN_RING,
                0 /*default */,
                UserHandle.USER_CURRENT) == 1) {

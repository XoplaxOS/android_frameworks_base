...
public class Halo extends FrameLayout implements Ticker.TickerCallback {
    ...
    private final class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HALO_HIDE), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HALO_NOTIFY_COUNT), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HAPTIC_FEEDBACK_ENABLED), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HALO_NOTIFY_SILENT), false, this);
        }
        ...
        public void onChange(boolean selfChange) {
            ContentResolver resolver = mContext.getContentResolver();
            mHaloHide =
                    Settings.XOPLAX.getInt(resolver,
                                Settings.XOPLAX.HALO_HIDE, 0) == 1;
            if (!selfChange) {
                //mEffect.wake();
                mBar.restartHalo();
    ...
    public Halo(Context context, AttributeSet attrs, int defStyle) {
        ...
        // Init variables
        mHaloHide =
                Settings.XOPLAX.getInt(resolver, Settings.XOPLAX.HALO_HIDE, 0) == 1;
        mHaloSize = Settings.XOPLAX.getFloat(resolver, Settings.XOPLAX.HALO_SIZE, 1.0f);
        ...
        mNotifySilent = Settings.XOPLAX.getInt(resolver,
                    Settings.XOPLAX.HALO_NOTIFY_SILENT, 0) == 1;
    ...
    class HaloEffect extends HaloProperties {
        ...
        public void refresh() {
            ...
            int haloCounterType = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.HALO_NOTIFY_COUNT, 4);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (mState == STATE_DRAG) {
                ...
                if (y != getHaloContentY()
                    ...
                    int msgAnimation = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                                            Settings.XOPLAX.HALO_MSGBOX_ANIMATION, 2);
                }
            }
                    ...
                    if (mIsNotificationNew) {
                        ...
                        if (mState != STATE_FIRST_RUN) {
                            ...
                            boolean showMsgBox = Settings.PAC
                                                         ...
                                                         Settings.XOPLAX.HALO_MSGBOX, 1) == 1;
                            mPingNewcomer = true;
    ...
    public class ScreenReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(Intent.ACTION_USER_PRESENT) &&
                    Settings.XOPLAX.getInt(resolver, Settings.XOPLAX.HALO_ACTIVE, 0) == 1 &&
                    Settings.XOPLAX.getInt(resolver, Settings.XOPLAX.HALO_UNLOCK_PING, 0) == 1 &&
                    ...
                    mHandler.postDelayed(new Runnable() {
                        public void run() {
                            ...
                            if (lastMsg > 0) {
                                ...
                                mEffect.wake();
                                mEffect.nap(HaloEffect.NAP_DELAY + HaloEffect.WAKE_TIME * 2);
                                boolean showMsgBox = Settings.XOPLAX.getInt(resolver,
                                                            Settings.XOPLAX.HALO_MSGBOX, 1) == 1;

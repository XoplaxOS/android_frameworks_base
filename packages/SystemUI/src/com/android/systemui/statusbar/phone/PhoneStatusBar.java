...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.STATUS_BAR_CUSTOM_HEADER), false, this);
            // Pie controls
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.PIE_CONTROLS), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
            ...
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.NOTIFICATION_BACKGROUND), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.NOTIFICATION_BACKGROUND_LANDSCAPE), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.NOTIFICATION_BACKGROUND_ALPHA), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.NOTIFICATION_ALPHA), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_EXPANDED), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_SNOOZE_TIME), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_NOTIFCATION_DECAY), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_SHOW_UPDATE), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_GRAVITY_BOTTOM), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HALO_ACTIVE), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.RECENT_CARD_BG_COLOR), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.RECENT_CARD_TEXT_COLOR), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_BG_COLOR), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_TEXT_COLOR), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.STATUS_BAR_CLOCK_LOCKSCREEN), false, this,
                    UserHandle.USER_ALL);
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (uri.equals(Settings.System.getUriFor(Settings.System.STATUS_BAR_CLOCK))) {
                updateClockLocation();
            // Pie controls
            } else if (uri.equals(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.PIE_CONTROLS))) {
                ...
                mNavigationBarOverlay.setIsExpanded(noNavBar());
                    ...
                    Settings.XOPLAX.NOTIFICATION_BACKGROUND))
                || uri.equals(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.NOTIFICATION_BACKGROUND_LANDSCAPE))
                || uri.equals(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.NOTIFICATION_BACKGROUND_ALPHA))) {
                ...
                Settings.XOPLAX.NOTIFICATION_ALPHA))) {
                setNotificationAlpha();
            } else if (uri.equals(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_EXPANDED))) {
                    mHeadsUpExpandedByDefault = Settings.XOPLAX.getIntForUser(
                            mContext.getContentResolver(),
                            Settings.XOPLAX.HEADS_UP_EXPANDED, 0,
                            UserHandle.USER_CURRENT) == 1;
            } else if (uri.equals(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_SNOOZE_TIME))) {
                    final int snoozeTime = Settings.XOPLAX.getIntForUser(
                            mContext.getContentResolver(),
                            Settings.XOPLAX.HEADS_UP_SNOOZE_TIME,
                    ...
                    Settings.XOPLAX.HEADS_UP_NOTIFCATION_DECAY))) {
                    mHeadsUpNotificationDecay = Settings.XOPLAX.getIntForUser(
                            mContext.getContentResolver(),
                            Settings.XOPLAX.HEADS_UP_NOTIFCATION_DECAY,
                    ...
                    Settings.XOPLAX.HEADS_UP_SHOW_UPDATE))) {
                    mShowHeadsUpUpdates = Settings.XOPLAX.getIntForUser(
                            mContext.getContentResolver(),
                            Settings.XOPLAX.HEADS_UP_SHOW_UPDATE, 0,
                            UserHandle.USER_CURRENT) == 1;
            } else if (uri.equals(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_GRAVITY_BOTTOM))) {
                    mHeadsUpGravityBottom = Settings.XOPLAX.getIntForUser(
                            mContext.getContentResolver(),
                            Settings.XOPLAX.HEADS_UP_GRAVITY_BOTTOM, 0,
                            UserHandle.USER_CURRENT) == 1;
                    updateHeadsUpPosition(mStatusBarShows);
            } else if (uri.equals(Settings.XOPLAX.getUriFor(
                Settings.XOPLAX.HALO_ACTIVE))) {
                updateHalo();
                // Switch off regular ticker
                mTickerView.setVisibility(View.GONE);
            } else if (uri.equals(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.RECENT_CARD_BG_COLOR))) {
                rebuildRecentsScreen();
            } else if (uri.equals(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.RECENT_CARD_TEXT_COLOR))) {
                rebuildRecentsScreen();
            } else if (uri.equals(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_BG_COLOR))) {
                    mHeadsUpCustomBg = Settings.XOPLAX.getIntForUser(
                        mContext.getContentResolver(),
                        Settings.XOPLAX.HEADS_UP_BG_COLOR, 0x00ffffff,
                        UserHandle.USER_CURRENT);
            } else if (uri.equals(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.HEADS_UP_TEXT_COLOR))) {
                    mHeadsUpCustomText = Settings.XOPLAX.getIntForUser(
                        mContext.getContentResolver(),
                        Settings.XOPLAX.HEADS_UP_TEXT_COLOR, 0,
                        UserHandle.USER_CURRENT);
            } else {
                updateSettings();
    ...
    private class TintedStatusbarObserver extends ContentObserver {
        ...
        void observe() {
            ContentResolver resolver = mContext.getContentResolver();
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.STATUS_BAR_TINTED_COLOR), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.STATUS_BAR_TINTED_OPTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.STATUS_BAR_TINTED_FILTER), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.STATUS_BAR_TINTED_STATBAR_TRANSPARENT), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.STATUS_BAR_TINTED_NAVBAR_TRANSPARENT), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.STATUS_BAR_TINTED_FULL_MODE), false, this,
                    UserHandle.USER_ALL);
            update();
        }
        ...
        public void update() {
            ...
            mCurrentColorProgress = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.STATUS_BAR_TINTED_COLOR, 0
                    , UserHandle.USER_CURRENT);
            mCurrentTintedProgress = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.STATUS_BAR_TINTED_OPTION, 0
                    , UserHandle.USER_CURRENT);
            mColorFilterEnabled = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.STATUS_BAR_TINTED_FILTER, 0
                    , UserHandle.USER_CURRENT) == 1;
            mStatusbarTransparent = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.STATUS_BAR_TINTED_STATBAR_TRANSPARENT, 100
                    , UserHandle.USER_CURRENT);
            mNavbarTransparent = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.STATUS_BAR_TINTED_NAVBAR_TRANSPARENT, 100
                    , UserHandle.USER_CURRENT);
            mColorFullMode = (mCurrentColorProgress == 2) && (Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.STATUS_BAR_TINTED_FULL_MODE, 0
                    , UserHandle.USER_CURRENT) == 1);
    ...
    private boolean isPieEnabled() {
        return Settings.XOPLAX.getIntForUser(mContext.getContentResolver(),
                Settings.XOPLAX.PIE_CONTROLS, 0,
                UserHandle.USER_CURRENT) == 1;
    }
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mWeatherPanelEnabled = (Settings.XOPLAX.getInt(cr,
                Settings.XOPLAX.STATUSBAR_WEATHER_STYLE, 1) == 1)
                && (Settings.XOPLAX.getBoolean(cr, Settings.XOPLAX.USE_WEATHER, false));
            ...
            if (mWifiLabel != null) {
                ...
                mWifiLabel.addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before,
                            int count) {
                            if (Settings.XOPLAX.getInt(mContext.getContentResolver(),
                                Settings.XOPLAX.NOTIFICATION_SHOW_WIFI_SSID, 0) == 1 &&
                                count > 0) {
    ...
    private void updateCustomHeaderStatus() {
        ContentResolver resolver = mContext.getContentResolver();
        boolean customHeader = Settings.XOPLAX.getInt(
                resolver, Settings.XOPLAX.STATUS_BAR_CUSTOM_HEADER, 0) == 1;
    ...
    private boolean isTickerEnabled() {
        return Settings.XOPLAX.getInt(mContext.getContentResolver(),
                Settings.XOPLAX.STATUS_BAR_TICKER_ENABLED, 1) == 1;
    }
    ...
    private void updateSettings() {
        ...
        showClockOnLockscreen = Settings.XOPLAX.getIntForUser(resolver,
                Settings.XOPLAX.STATUS_BAR_CLOCK_LOCKSCREEN, 0, mCurrentUserId) == 1;
...
//            Log.d(TAG, "size=" + newIconSize + " padding=" + newIconHPadding);
    ...
    private class TilesChangedObserver extends ContentObserver {
        ...
        public void update() {
            ...
            mShortClickWeather = Settings.XOPLAX.getString(cr,
                    Settings.XOPLAX.WEATHER_PANEL_SHORTCLICK);

            mLongClickWeather = Settings.XOPLAX.getString(cr,
                    Settings.XOPLAX.WEATHER_PANEL_LONGCLICK);
        }
        ...
        public void startObserving() {
            ...
            cr.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.STATUSBAR_WEATHER_STYLE),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.USE_WEATHER),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.WEATHER_PANEL_SHORTCLICK),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.WEATHER_PANEL_LONGCLICK),
                    false, this, UserHandle.USER_ALL);
    ...
    private void setNotificationAlpha() {
        ...
        float notifAlpha = Settings.XOPLAX.getFloatForUser(
            mContext.getContentResolver(), Settings.XOPLAX.NOTIFICATION_ALPHA,

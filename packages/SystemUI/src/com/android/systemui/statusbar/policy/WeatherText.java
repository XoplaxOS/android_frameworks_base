...
public class WeatherText extends TextView {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.USE_WEATHER), false,
                    this);
            resolver.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.WEATHER_SHOW_LOCATION), false,
                    this);
            resolver.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.STATUSBAR_WEATHER_STYLE), false,
                    this);
            updateSettings();
        }
    ...
    protected void updateSettings() {
        ContentResolver resolver = mContext.getContentResolver();
        boolean useWeather = (Settings.XOPLAX.getBoolean(resolver, Settings.XOPLAX.USE_WEATHER, false)
                && Settings.XOPLAX.getInt(resolver, Settings.XOPLAX.STATUSBAR_WEATHER_STYLE, 1) == 0);

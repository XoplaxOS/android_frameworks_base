...
public class BatteryBarController extends LinearLayout {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observer() {
            ...
            resolver.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.STATUSBAR_BATTERY_BAR), false, this);
            resolver.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.STATUSBAR_BATTERY_BAR_STYLE), false,
                    this);
            resolver.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.STATUSBAR_BATTERY_BAR_THICKNESS),
                    false, this);
        }
    ...
    public void addBars() {
        ...
        float dp = (float) Settings.XOPLAX.getInt(getContext().getContentResolver(),
                Settings.XOPLAX.STATUSBAR_BATTERY_BAR_THICKNESS, 1);
    ...
    public void updateSettings() {
        mStyle = Settings.XOPLAX.getInt(getContext().getContentResolver(),
                Settings.XOPLAX.STATUSBAR_BATTERY_BAR_STYLE, 0);
        mLocation = Settings.XOPLAX.getInt(getContext().getContentResolver(),
                Settings.XOPLAX.STATUSBAR_BATTERY_BAR, 0);

...
public class BatteryBar extends RelativeLayout implements Animatable {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observer() {
            ...
            resolver.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.STATUSBAR_BATTERY_BAR_COLOR), false,
                    this);
            resolver.registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.STATUSBAR_BATTERY_BAR_ANIMATE),
                    false, this);
        }
    ...
    private void updateSettings() {
        ...
        int color = Settings.XOPLAX.getInt(resolver, Settings.XOPLAX.STATUSBAR_BATTERY_BAR_COLOR,
                0xFFFFFFFF);

        shouldAnimateCharging = Settings.XOPLAX.getInt(resolver,
                Settings.XOPLAX.STATUSBAR_BATTERY_BAR_ANIMATE, 0) == 1;

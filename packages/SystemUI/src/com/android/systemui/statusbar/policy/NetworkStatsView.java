    ...
    class SettingsObserver extends ContentObserver {
        ...
        public void observe() {
            ...
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.STATUS_BAR_NETWORK_STATS), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.STATUS_BAR_NETWORK_STATS_UPDATE_INTERVAL), false, this);
            onChange(true);
        }
        ...
        public void onChange(boolean selfChange) {
            ...
            mActivated = (Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.STATUS_BAR_NETWORK_STATS, 0)) == 1
                    && networkAvailable;

            mRefreshInterval = Settings.XOPLAX.getLong(mContext.getContentResolver(),
                    Settings.XOPLAX.STATUS_BAR_NETWORK_STATS_UPDATE_INTERVAL, 500);

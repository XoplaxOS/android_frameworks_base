    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ENABLE_ACTIVE_DISPLAY), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_TEXT), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_ALL_NOTIFICATIONS), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_HIDE_LOW_PRIORITY_NOTIFICATIONS), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_POCKET_MODE), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_REDISPLAY), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_BRIGHTNESS), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_SUNLIGHT_MODE), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_EXCLUDED_APPS), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_PRIVACY_APPS), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.SCREEN_BRIGHTNESS_MODE), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_TIMEOUT), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_TURNOFF_MODE), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_THRESHOLD), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_CONTENT), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_BYPASS), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.BATTERY_AROUND_LOCKSCREEN_RING), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.STATUS_BAR_NOTIF_COUNT), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_ANNOYING), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_DOUBLE_TAP), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_EVENT), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_FORCE), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_QUITE_HOURS), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_THRESHOLD), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_LONGTHRESHOLD), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_TIMEOUT), false, this);
            update();
        }
        ...
        public void update() {
            ...
            mActiveDisplayEnabled = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ENABLE_ACTIVE_DISPLAY, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            mDisplayNotificationText = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_TEXT, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            mShowAllNotifications = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_ALL_NOTIFICATIONS, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            mHideLowPriorityNotifications = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_HIDE_LOW_PRIORITY_NOTIFICATIONS, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            mPocketMode = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_POCKET_MODE, POCKET_MODE_OFF,
                    UserHandle.USER_CURRENT_OR_SELF);
            mRedisplayTimeout = Settings.XOPLAX.getLongForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_REDISPLAY, 0L,
                    UserHandle.USER_CURRENT_OR_SELF);
            mInitialBrightness = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_BRIGHTNESS, mMaximumBacklight,
                    UserHandle.USER_CURRENT_OR_SELF);
            mSunlightModeEnabled = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_SUNLIGHT_MODE, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            String excludedApps = Settings.XOPLAX.getStringForUser(resolver,
                    Settings.XOPLAX.ACTIVE_DISPLAY_EXCLUDED_APPS,
                    UserHandle.USER_CURRENT_OR_SELF);
            String privacyApps = Settings.XOPLAX.getStringForUser(resolver,
                    Settings.XOPLAX.ACTIVE_DISPLAY_PRIVACY_APPS,
                    UserHandle.USER_CURRENT_OR_SELF);
            mDisplayTimeout = Settings.XOPLAX.getLongForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_TIMEOUT, mDisplayTimeout,
                    UserHandle.USER_CURRENT_OR_SELF);
            mTurnOffModeEnabled = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_TURNOFF_MODE, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1;
            mProximityThreshold = Settings.XOPLAX.getLongForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_THRESHOLD, mProximityThreshold,
                    UserHandle.USER_CURRENT_OR_SELF);
            mUseActiveDisplayContent = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_CONTENT, 1,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mBypassActiveDisplay = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_BYPASS, 1,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mBatteryLockscreen = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.BATTERY_AROUND_LOCKSCREEN_RING, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mShowNotificationCount = Settings.System.getIntForUser(
                    resolver, Settings.System.STATUS_BAR_NOTIF_COUNT, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mIsAnnoyingThreshold = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_ANNOYING, 0,
                    UserHandle.USER_CURRENT_OR_SELF);
            mEnableDoubleTap = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_DOUBLE_TAP, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mEnableShake = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_EVENT, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mEnableShakeForce = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_FORCE, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mDisableShakeQuite = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_QUITE_HOURS, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mShakeThreshold = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_THRESHOLD, mShakeThreshold,
                    UserHandle.USER_CURRENT_OR_SELF);
            mShakeLongThreshold = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_LONGTHRESHOLD, mShakeLongThreshold,
                    UserHandle.USER_CURRENT_OR_SELF);
            mShakeTimeout = Settings.XOPLAX.getIntForUser(
                    resolver, Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_TIMEOUT, mShakeTimeout,
                    UserHandle.USER_CURRENT_OR_SELF);

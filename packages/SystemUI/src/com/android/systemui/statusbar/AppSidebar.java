    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.APP_SIDEBAR_ENABLED), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.APP_SIDEBAR_TRANSPARENCY), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.APP_SIDEBAR_POSITION), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.APP_SIDEBAR_DISABLE_LABELS), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.APP_SIDEBAR_TRIGGER_WIDTH), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.APP_SIDEBAR_TRIGGER_TOP), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.APP_SIDEBAR_TRIGGER_HEIGHT), false, this);
            resolver.registerContentObserver(Settings.XOPLAX.getUriFor(
                    Settings.XOPLAX.APP_SIDEBAR_SHOW_TRIGGER), false, this);
            update();
        }
        ...
        public void update() {
            ContentResolver resolver = mContext.getContentResolver();
            boolean enabled = Settings.XOPLAX.getInt(
                    resolver, Settings.XOPLAX.APP_SIDEBAR_ENABLED, 0) == 1;
            setVisibility(enabled ? View.VISIBLE : View.GONE);

            float barAlpha = (float)(100 - Settings.XOPLAX.getInt(
                    resolver, Settings.XOPLAX.APP_SIDEBAR_TRANSPARENCY, 0)) / 100f;
            ...
            int position = Settings.XOPLAX.getInt(
                    resolver, Settings.XOPLAX.APP_SIDEBAR_POSITION, SIDEBAR_POSITION_LEFT);
            if (position != mPosition) {
                mPosition = position;
                createSidebarAnimations(position);
            }

            boolean hideLabels = Settings.XOPLAX.getInt(
                    resolver, Settings.XOPLAX.APP_SIDEBAR_DISABLE_LABELS, 0) == 1;
            ...
            int width = Settings.XOPLAX.getInt(
                    resolver, Settings.XOPLAX.APP_SIDEBAR_TRIGGER_WIDTH, 10);
            if (mTriggerWidth != width)
                setTriggerWidth(width);
            setTopPercentage(Settings.XOPLAX.getInt(
                    resolver, Settings.XOPLAX.APP_SIDEBAR_TRIGGER_TOP, 0) / 100f);
            setBottomPercentage(Settings.XOPLAX.getInt(
                    resolver, Settings.XOPLAX.APP_SIDEBAR_TRIGGER_HEIGHT, 100) / 100f);
            if (Settings.XOPLAX.getInt(
                    resolver, Settings.XOPLAX.APP_SIDEBAR_SHOW_TRIGGER, 0) == 1)
                showTriggerRegion();
            else
                hideTriggerRegion();
        }

...
public class PieItem extends PieView.PieDrawable {
    ...
    public PieItem(Context context, PieView parent, int flags, int width, String tag,
        ...
        float backgroundAlpha = Settings.XOPLAX.getFloatForUser(context.getContentResolver(),
                Settings.XOPLAX.PIE_BUTTON_ALPHA, 0.3f,
                UserHandle.USER_CURRENT);
        float backgroundSelectedAlpha = Settings.XOPLAX.getFloatForUser(
                context.getContentResolver(),
                Settings.XOPLAX.PIE_BUTTON_PRESSED_ALPHA, 0.0f,
                UserHandle.USER_CURRENT);

        int backgroundPaintColor = Settings.XOPLAX.getIntForUser(context.getContentResolver(),
                Settings.XOPLAX.PIE_BUTTON_COLOR, -2,
                UserHandle.USER_CURRENT);
        ...
        int selectedPaintColor = Settings.XOPLAX.getIntForUser(context.getContentResolver(),
                Settings.XOPLAX.PIE_BUTTON_PRESSED_COLOR, -2,
                UserHandle.USER_CURRENT);
        ...
        int longPressPaintColor = Settings.XOPLAX.getIntForUser(context.getContentResolver(),
                Settings.XOPLAX.PIE_BUTTON_LONG_PRESSED_COLOR, -2,
                UserHandle.USER_CURRENT);
        ...
        int outlinePaintColor = Settings.XOPLAX.getIntForUser(context.getContentResolver(),
                Settings.XOPLAX.PIE_BUTTON_OUTLINE_COLOR, -2,
                UserHandle.USER_CURRENT);

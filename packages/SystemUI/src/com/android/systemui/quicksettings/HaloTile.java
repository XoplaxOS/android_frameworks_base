...
public class HaloTile extends QuickSettingsTile {
    ...
    public HaloTile(Context context, QuickSettingsController qsc, Handler handler) {
        ...
        mOnClick = new OnClickListener() {
            ...
            public void onClick(View v) {
                Settings.XOPLAX.putInt(mContext.getContentResolver(), Settings.XOPLAX.HALO_ACTIVE, getHaloState() ? 1 : 0);
            }
        };
        ...
        qsc.registerObservedContent(Settings.XOPLAX.getUriFor(Settings.XOPLAX.HALO_ACTIVE)
                , this);
    }
    ...
    private boolean getHaloState() {
        return !Settings.XOPLAX.getBoolean(mContext.getContentResolver(), Settings.XOPLAX.HALO_ACTIVE, false);
    }

...
public class LinearColorBar extends LinearLayout {
    ...
    private void updateModeAndColors() {
        mRamBarMode = (Settings.XOPLAX.getInt(mContext.getContentResolver(),
                             Settings.XOPLAX.RECENTS_RAM_BAR_MODE, 0));
        mUsedMemColor = (Settings.XOPLAX.getInt(mContext.getContentResolver(),
                               Settings.XOPLAX.RECENTS_RAM_BAR_MEM_COLOR, USED_MEM_COLOR));
        mUsedCacheMemColor = (Settings.XOPLAX.getInt(mContext.getContentResolver(),
                                    Settings.XOPLAX.RECENTS_RAM_BAR_CACHE_COLOR, USED_CACHE_COLOR));
        mUsedActiveAppsMemColor = (Settings.XOPLAX.getInt(mContext.getContentResolver(),
                                         Settings.XOPLAX.RECENTS_RAM_BAR_ACTIVE_APPS_COLOR, USED_ACTIVE_APPS_COLOR));
    }

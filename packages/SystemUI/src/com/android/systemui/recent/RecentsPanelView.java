...
public class RecentsPanelView extends FrameLayout implements OnItemClickListener, RecentsCallback,
    ...
    private void showImpl(boolean show) {
        ...
        if (show) {
            ...
            boolean showClearAllButton = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.SHOW_CLEAR_RECENTS_BUTTON, 1) == 1;

            if (showClearAllButton) {
                mClearRecents.setVisibility(noApps ? View.GONE : View.VISIBLE);

                int clearAllButtonLocation = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                        Settings.XOPLAX.CLEAR_RECENTS_BUTTON_LOCATION,
    ...
    private void updateRamBar() {
        ...
        int mRamBarMode = (Settings.XOPLAX.getInt(mContext.getContentResolver(),

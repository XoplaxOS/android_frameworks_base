...
import com.android.internal.util.xoplax.AwesomeAnimationHelper;
...
public class InputMethodService extends AbstractInputMethodService {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            getContentResolver().registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.ANIMATION_IME_DURATION),
                                    false, this);
            getContentResolver().registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.ANIMATION_IME_ENTER),
                                    false, this);
            getContentResolver().registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.ANIMATION_IME_EXIT),
                                    false, this);
            getContentResolver().registerContentObserver(
                    Settings.XOPLAX.getUriFor(Settings.XOPLAX.ANIMATION_IME_INTERPOLATOR),
                                    false, this);
    ...
    private void updateSettings() {
        mAnimationEnterIndex = Settings.XOPLAX.getInt(getContentResolver(),
                      Settings.XOPLAX.ANIMATION_IME_ENTER, 0);
        mAnimationExitIndex = Settings.XOPLAX.getInt(getContentResolver(),
                      Settings.XOPLAX.ANIMATION_IME_EXIT, 0);
        mInterpolatorIndex = Settings.XOPLAX.getInt(getContentResolver(),
                      Settings.XOPLAX.ANIMATION_IME_INTERPOLATOR, 0);
        int temp = Settings.XOPLAX.getInt(getContentResolver(),
                      Settings.XOPLAX.ANIMATION_IME_DURATION, 0);
    ...
    public void updateFullscreenMode() {
        boolean fullScreenOverride = Settings.XOPLAX.getIntForUser(getContentResolver(),
                Settings.XOPLAX.DISABLE_FULLSCREEN_KEYBOARD, 0,
    ...
    public void showWindow(boolean showInput) {
        ...
        int mKeyboardRotationTimeout = Settings.XOPLAX.getIntForUser(getContentResolver(),
                Settings.XOPLAX.KEYBOARD_ROTATION_TIMEOUT, 0, UserHandle.USER_CURRENT_OR_SELF);

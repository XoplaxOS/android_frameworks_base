...
class IInputMethodWrapper extends IInputMethod.Stub
    ...
    public void executeMessage(Message msg) {
        ...
        boolean formalText = Settings.XOPLAX.getIntForUser(mCaller.mContext.getContentResolver(),
                Settings.XOPLAX.FORMAL_TEXT_INPUT, 0, UserHandle.USER_CURRENT_OR_SELF) == 1;

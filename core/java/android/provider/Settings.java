...
public final class Settings {
    ...
    /**
     * @hide - Private call() method on SettingsProvider to read from 'xoplax' table.
     */
    public static final String CALL_METHOD_GET_XOPLAX = "GET_xoplax";
    ...
    /** @hide - Private call() method to write to 'xoplax' table */
    public static final String CALL_METHOD_PUT_XOPLAX = "PUT_xoplax";
    ...
    /**
     * XoplaX settings, containing XoplaX specific preferences.  This
     * table holds simple name/value pairs.  There are convenience
     * functions for accessing individual settings entries.
     */
    public static final class XoplaX extends NameValueTable {
        public static final String SYS_PROP_SETTING_VERSION = "sys.settings_system_version";
         ...
         */
        public static final Uri CONTENT_URI =
            Uri.parse("content://" + AUTHORITY + "/xoplax");

        private static final NameValueCache sNameValueCache = new NameValueCache(
                SYS_PROP_SETTING_VERSION,
                CONTENT_URI,
                CALL_METHOD_GET_XOPLAX,
                CALL_METHOD_PUT_XOPLAX);
    ...
    /**
     * End of XoplaX Features Setting
     */
    }

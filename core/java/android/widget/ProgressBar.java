...
public class ProgressBar extends View {
    ...
    public ProgressBar(Context context, AttributeSet attrs, int defStyle, int styleRes) {
        ...
        if (String.valueOf(drawable).contains("android.graphics.drawable.AnimationDrawabl")) {
            boolean IsMirrorMode = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.PROGRESSBAR_MIRROR, 0) == 1;
            boolean IsReversed = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.PROGRESSBAR_REVERSE, 0) == 1;
            int tmpSpeed = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.PROGRESSBAR_SPEED, 4);
            float Speed = ((float) tmpSpeed + 1 ) / 10;
            int Width = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.PROGRESSBAR_WIDTH, 4);
            int Length = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.PROGRESSBAR_LENGTH, 10);
            int Count = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.PROGRESSBAR_COUNT, 6);
            int Color1 = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.PROGRESSBAR_COLOR_1, 0xffffff00);
            int Color2 = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.PROGRESSBAR_COLOR_2, 0xff99cc00);
            int Color3 = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.PROGRESSBAR_COLOR_3, 0xffaa66cc);
            int Color4 = Settings.XOPLAX.getInt(mContext.getContentResolver(),
                    Settings.XOPLAX.PROGRESSBAR_COLOR_4, 0xff00ddff);
